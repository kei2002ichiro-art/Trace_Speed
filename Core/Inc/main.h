...
#define MOT_EN_GPIO_Port GPIOF
#define MOT_R_DIR_Pin GPIO_PIN_1
#define MOT_R_DIR_GPIO_Port GPIOF
...
#define MOT_L_DIR_Pin GPIO_PIN_10
#define MOT_L_DIR_GPIO_Port GPIOA
...
#define SW_MID_Pin GPIO_PIN_4
#define SW_MID_GPIO_Port GPIOB
